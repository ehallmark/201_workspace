...
public class GUIController extends JFrame {
	...
	public static Color OFFSET_COLOR = new Color(255,110,0);
	public static Color LOGO_COLOR = new Color(255,69,0);
	...
	private void showUserButtons() {
		// display login signup buttons if not already shown
		this.getContentPane().add(firstWindow, BorderLayout.CENTER);
	}
	...
	private void initTabbedPane() {		
		tabbed_pane = new CustomTabbedPane();
	...
	private void generatePostLoginUI() {
	...
	private void generatePreLoginUI() {
